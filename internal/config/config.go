...
type WebDAVConfig struct {
	...
	ConfigPath string `json:"configPath"` // Config backup path (default /CodeAgentLens/config)
	StatsPath  string `json:"statsPath"`  // Stats backup path (default /CodeAgentLens/stats)
}
