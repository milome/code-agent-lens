        ...
        <div class="footer">
            <div class="footer-content">
                <div class="footer-left">
                    <span style="opacity: 0.8;">© 2025 CodeAgentLens</span>
                </div>
        ...
        <div id="welcomeModal" class="modal">
            <div class="modal-content" style="max-width: min(600px, 90vw);">
                ...
                <div class="modal-body">
                    ...
                    <div style="margin: 24px 0; padding: 18px; background: var(--bg-secondary); border-radius: 10px;">
                        <h3 style="margin-top: 0;">${t('welcome.features')}</h3>
