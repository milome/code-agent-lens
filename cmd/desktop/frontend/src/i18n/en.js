export default {
    ...
    welcome: {
        title: 'Welcome to CodeAgentLens!',
        titleWithVersion: '👋 Welcome to CodeAgentLens v{version}',
        message: 'CodeAgentLens is a smart API endpoint round-robin proxy for Claude Code',
        features: 'Features',
        ...
        qrCodeTip: 'Use the GitHub repository for project updates',
        chatGroupTip: 'Use GitHub Issues and Discussions for feedback',
        chatGroupFallbackTip: 'Use GitHub Issues for support',
    ...
    webdav: {
        ...
        serverUrlHelp: 'Remote backup is deferred from the first public release',
        username: 'Username',
        password: 'Password',
        usernamePlaceholder: 'Enter remote username',
        passwordPlaceholder: 'Enter remote password',
        urlRequired: 'Please enter remote server URL',
        onlyNutstore: 'Remote backup is deferred from the first public release',
        usernameRequired: 'Please enter username',
        passwordRequired: 'Please enter password',
        connectionSuccess: 'Connection successful',
        connectionFailed: 'Connection failed',
        connectionFailedWithRecommend: 'Connection failed',
        ...
        remoteBackup: 'Imported Backup',
        endpoints: 'Endpoints',
        port: 'Port',
        chooseConfig: 'Please choose which configuration to use:',
        useRemote: 'Use Imported Backup',
        ...
        useRemoteDesc: 'Imported configuration will overwrite local conflicting endpoints',
        keepLocalDesc: 'Keep local configuration, only add new endpoints from remote',
        // Error messages
        errors: {
            webdav_not_configured: 'Remote backup not configured',
            storage_not_initialized: 'Storage not initialized',
            webdav_client_failed: 'Failed to create remote backup client',
    ...
    backup: {
        ...
        s3: {
            title: 'Remote Object Backup',
            endpoint: 'Endpoint',
            endpointPlaceholder: 'remote object endpoint',
            region: 'Region',
            regionPlaceholder: 'e.g. us-east-1',
            bucket: 'Bucket',
            prefix: 'Prefix',
            prefixPlaceholder: 'e.g. CodeAgentLens/',
        ...
        errors: {
            ...
            backup_s3_not_configured: 'Remote object backup not configured',
            backup_s3_endpoint_invalid: 'Invalid remote object endpoint (use host:port or https://host:port)',
            backup_s3_endpoint_path_not_supported: 'Remote object endpoint must not contain path, please put it into Prefix',
            s3_client_failed: 'Failed to create remote object client',
    ...
    update: {
        ...
        install_instructions_windows: '1. Close current CodeAgentLens application<br>2. Run the new CodeAgentLens.exe',
        install_instructions_macos: '1. Close current CodeAgentLens application<br>2. Drag the new CodeAgentLens.app to Applications folder',
        install_instructions_linux: '1. Close current CodeAgentLens application<br>2. Run the new CodeAgentLens executable',
    ...
    tips: [
        ...
        'Tip: Manual local database copies are the first-release backup path',
