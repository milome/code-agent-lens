export default {
    ...
    welcome: {
        title: '欢迎使用 CodeAgentLens！',
        titleWithVersion: '👋 欢迎使用 CodeAgentLens v{version}',
        message: 'CodeAgentLens 是一个为 Claude Code 设计的智能 API 端点轮询代理工具',
        features: '功能特性',
        ...
        getStarted: '开始使用',
        dontShow: '不再显示',
        qrCodeTip: '使用 GitHub 仓库获取项目更新',
        chatGroupTip: '使用 GitHub Issues 和 Discussions 反馈问题',
        chatGroupFallbackTip: '使用 GitHub Issues 获取支持',
        readArticle: '阅读介绍',
        githubRepo: '🔗 GitHub 仓库',
        changelog: '📋 更新日志'
    },
    ...
    webdav: {
        ...
        serverUrl: '远程服务器地址',
        serverUrlHelp: '远程备份不在首发版本承诺范围内',
        username: '用户名',
        password: '密码',
        usernamePlaceholder: '输入远程用户名',
        passwordPlaceholder: '输入远程密码',
        urlRequired: '请输入远程服务器地址',
        onlyNutstore: '远程备份不在首发版本承诺范围内',
        usernameRequired: '请输入用户名',
        passwordRequired: '请输入密码',
        connectionSuccess: '连接成功',
        connectionFailed: '连接失败',
        connectionFailedWithRecommend: '连接失败',
        testRequired: '请先测试连接',
        testConnection: '测试连接',
        backup: '备份',
        backupManager: '备份管理器',
        ...
        useRemoteDesc: '导入的配置将覆盖本地冲突的端点配置',
        keepLocalDesc: '保留本地配置，仅从远程添加新端点',
        inputFilename: '输入文件名',
        // 错误消息
        errors: {
            webdav_not_configured: '远程备份未配置',
            storage_not_initialized: '存储未初始化',
            webdav_client_failed: '创建远程备份客户端失败',
    ...
    backup: {
        ...
        s3: {
            title: '远程对象备份',
            endpoint: '服务端点',
            endpointPlaceholder: '远程对象端点',
            region: '区域',
            regionPlaceholder: '如：us-east-1',
            bucket: '存储桶',
            prefix: '路径前缀',
            prefixPlaceholder: '如：CodeAgentLens/',
            accessKey: '访问密钥',
            secretKey: '密钥密码',
            sessionToken: '会话令牌',
            useSSL: '使用 HTTPS',
        ...
        errors: {
            ...
            backup_s3_not_configured: '远程对象备份未配置',
            backup_s3_endpoint_invalid: '远程对象端点无效（请填写 host:port 或 https://host:port）',
            backup_s3_endpoint_path_not_supported: '远程对象端点不支持包含路径，请将路径部分填写到 Prefix',
            s3_client_failed: '创建远程对象客户端失败',
    ...
    update: {
        ...
        extractPath: '文件位置',
        install_instructions_windows: '1. 关闭当前 CodeAgentLens 应用<br>2. 运行新版本的 CodeAgentLens.exe',
        install_instructions_macos: '1. 关闭当前 CodeAgentLens 应用<br>2. 将新版本的 CodeAgentLens.app 拖到应用程序文件夹',
        install_instructions_linux: '1. 关闭当前 CodeAgentLens 应用<br>2. 运行新版本的 CodeAgentLens 可执行文件',
